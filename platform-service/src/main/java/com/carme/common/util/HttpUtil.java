...
public final class HttpUtil {
                                                                   ...
                                                                   public String handleResponse(HttpResponse response)
                                                                       ...
                                                                       if (entity != null) {
                                                                           ...
                                                                           String charset = EntityUtils
                                                                               .getContentCharSet(entity) == null ? CHARSET_GBK
                                                                               : EntityUtils
     ...
     * @throws SystemException
     */
    public static String get(String url, Map<String, String> params) throws CommonException {
    ...
    public static String get(String url, Map<String, String> params, String charset)
        ...
        if (qparams != null && qparams.size() > 0) {
            ...
            urls = (urls.indexOf('?')) < 0 ? (urls + "?" + formatParams) : (urls.substring(0,
                urls.indexOf('?') + 1) + formatParams);
        }
     ...
     * @throws SystemException
     */
    public static String post(String url, Map<String, String> params) throws CommonException {
    ...
    public static String getHttpsUrlIgnoreCheck(String url) {
    ...
    public static String postHttpsUrlIgnoreCheck(String url, Map<String, String> map) {
        HttpClient httpClient = null;
        HttpPost httpPost = null;
        String result = null;
        map.put("authuser", "*****");
